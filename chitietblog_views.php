...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>frontend/chitietblog.css">
...
<body>
	...
	<div class="header">
		...
		<div class="color">
	 		<div class="tintuc">
	 		<div class="box_left">
	 			<h5><?php echo $data[2]["chitiet"][0]["title"] ?></h5>
	 			<br><br>
	 			<p><?php echo $data[2]["chitiet"][0]["content"] ?></p>
	 		</div>
